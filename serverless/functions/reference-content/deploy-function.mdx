...
Deploying larger projects with dependencies and many files requires zipping your code before uploading it. This is covered in our [tutorial on packaging functions in a zip file](/serverless/functions/how-to/package-function-dependencies-in-zip/).
